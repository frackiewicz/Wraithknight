...
namespace Wraithknight
{
    class DrawComponent : BindableComponent
    {
        ...
        #region Constructors
        public DrawComponent(Texture2D texture = null, AABB? drawRec = null, Point? size = null, Vector2? offset = null, float rotation = 0, Color? tint = null, float layerDepth = 0.1f) //TODO enum for layerdepth?
        {
