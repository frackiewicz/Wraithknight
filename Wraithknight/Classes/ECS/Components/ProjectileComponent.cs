...
{ 
    class ProjectileComponent : Component //TODO Cleanup?
    {
        ...
        public ProjectileComponent(int power = 0, int damage = 0, bool isPhasing = false, double hitCooldownMilliseconds = -1)
        {
            Power = power;
            Damage = damage;
            IsPhasing = isPhasing;
